    ...
    <div className="min-h-screen flex w-full">
      <div className="hidden lg:flex w-[40%] bg-primary flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="font-heading text-4xl text-white font-bold leading-tight mb-4">Account Deactivated</h2>
          <p className="text-primary-muted italic">"Please contact the administration if you think this is a mistake."</p>
        </div>
        <div className="relative z-10 flex gap-4">
          <span className="bg-white/10 text-white px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm">Contact Admin</span>
        </div>
      </div>
      <div className="flex-1 flex flex-col justify-center items-center p-6 bg-background">
        <div className="w-full max-w-md text-center space-y-6 animate-fade-up">
          ...
          <h1 className="font-heading text-3xl font-bold text-red-600">Account Deactivated</h1>
