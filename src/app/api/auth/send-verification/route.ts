...
export async function POST(req: Request) {
  try {
    ...
    // 6. Delete any existing unused tokens for this email first
    await supabaseAdmin
    ...
    try {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; color: #1A3A2A; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; padding: 20px; border-radius: 8px;">
            ...
            <p style="font-size: 16px; line-height: 1.5; color: #333;">
              Click below to verify your email and complete your registration. Link expires in 1 hour.
            </p>
      ...
      // 9. If sendMail throws: delete the token from DB, log error, return 500
