          ...
          <AnimatePresence>
            {showBell && (
              <motion.div
                ...
                className="fixed left-4 right-4 top-16 rounded-2xl bg-white shadow-xl border border-slate-100 dark:bg-[#182218] dark:border-[#2A3A2B] overflow-hidden z-50 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80"
              >
